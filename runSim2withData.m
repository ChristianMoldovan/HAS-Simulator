function [QoE,E1vod,E2vod,E1live,E2live,N,L,rate,ratio,StallingRatio] = runSim2withData(bwPerSecond,Sij,timeOfFrameDownload,d,cv,plotme,arrival,service,policy)
% close all;
% lambda = 10; % fps
% mu = 25; % fps
% close all;
...
if (strcmp(service,'D'))
    ...
    tmu = generateVideo(service, duration, cv, mu);
end
Sij = tmu;
